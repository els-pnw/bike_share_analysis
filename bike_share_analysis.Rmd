...
### Bike Share: Number of Riders By Weekday and Rider Type
Here we visualize the number of riders by day of week and whether the rider is a member of casual.
...
ggplot(rider_analysis) +
  ...
  scale_y_continuous(labels = scales::comma, 
                     limits = c(0,max(rider_analysis$number_of_riders) + 100000)) +
...
- Introduce a weekend only membership.
